...
*/
/**************************************************************************/
Adafruit_MCP4725_1::Adafruit_MCP4725_1() {}
...
*/
/**************************************************************************/
bool Adafruit_MCP4725_1::begin(uint8_t i2c_address, TwoWire *wire) {
  if (i2c_dev) {
    delete i2c_dev;
  }
...
*/
/**************************************************************************/
bool Adafruit_MCP4725_1::setVoltage(uint16_t output, bool writeEEPROM,
