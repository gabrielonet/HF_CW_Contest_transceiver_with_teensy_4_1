...
*/
/**************************************************************************/
Adafruit_MCP4725_2::Adafruit_MCP4725_2() {}
...
*/
/**************************************************************************/
bool Adafruit_MCP4725_2::begin(uint8_t i2c_address, TwoWire *wire) {
  if (i2c_dev) {
    delete i2c_dev;
  }
...
*/
/**************************************************************************/
bool Adafruit_MCP4725_2::setVoltage(uint16_t output, bool writeEEPROM,
